...
@gggne.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}ترامب <text>",
        "examples": "{tr}trump  is One of the Popular gggne",
    },
)
...
@gggne.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}غير عقلي Catgggne is One of the Popular gggne",
    },
)
async def nekobot(cat):
    text = cat.pattern_match.group(1)
...
@gggne.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}كانا text",
        "examples": "{tr}kanna  is One of the Popular gggne",
    },
)
async def nekobot(cat):
...
@gggne.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; is One of the Popular gggne",
    },
)
async def nekobot(cat):
