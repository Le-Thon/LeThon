...
from . import edit_delete, edit_or_reply, gggne


@gggne.ar_cmd(pattern="صلاة(?:\s|$)([\s\S]*)")
async def get_adzan(adzan):
    ...
    if request.status_code != 200:
        await edit_delete(
            ...
            15,
        )  # ترجمه فريق ليثون على التيلكرام
        return
    result = json.loads(request.text)
    gggneresult = f"<b>اوقات صلاه المسلمين 👳‍♂️ </b>\
    ...
    "
    await edit_or_reply(adzan, gggneresult, "html")
