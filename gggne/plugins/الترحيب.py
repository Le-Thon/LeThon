...
@gggne.ar_cmd(pattern="ترحيب(?:\s|$)([\s\S]*)")
...
@gggne.ar_cmd(pattern="الغاء الترحيب$")
...
@gggne.ar_cmd(pattern="الترحيبات$")
...
@gggne.ar_cmd(pattern="الترحيب السابق (تشغيل|ايقاف)$")
async def del_welcome(event):
