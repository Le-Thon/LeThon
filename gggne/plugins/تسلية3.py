...
from . import edit_delete, edit_or_reply, gggne, mention
...
async def _(event):
    ...
    animation_chars = [
        ...
        "**Starting process with command** `python3 -m gggne`",
        "**State changed from starting to up**",
        "__INFO:gggne:Logged in as 557667062__",
        "__INFO:gggne:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
...
@gggne.on(admin_cmd(pattern="احبك"))
async def rz(gggne):
    roz = random.choice(love)
    return await edit_or_reply(gggne, roz)
