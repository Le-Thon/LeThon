# gggne module for purging unneeded messages(usually spam or ot).
import re
...
@gggne.ar_cmd(pattern="حذف رسائلي")
...
@gggne.ar_cmd(pattern="تنظيف(?:\s|$)([\s\S]*)")
