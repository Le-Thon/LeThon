...
async def fakegs(search, result):
    ...
    blue = (0, 0, 255)
    black = (0, 0, 0)
    font1 = ImageFont.truetype("gggne/helpers/styles/ProductSans-BoldItalic.ttf", 20)
    font2 = ImageFont.truetype("gggne/helpers/styles/ProductSans-Light.ttf", 23)
...
async def trumptweet(text):
    ...
    with open("temp.png", "wb") as f:
        f.write(requests.get(Leo).content)
