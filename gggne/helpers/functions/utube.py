...
PATH = "./gggne/cache/ytsearch.json"
...
async def yt_search(gggne):
    try:
        gggne = urllib.parse.quote(gggne)
        html = urllib.request.urlopen(
            f"https://www.youtube.com/results?search_query={gggne}"
        )
...
"""
async def yt_data(gggne):
    params = {"format": "json", "url": gggne}
