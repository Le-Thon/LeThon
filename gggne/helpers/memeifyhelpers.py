...
async def gggne_meme(CNG_FONTS, topString, bottomString, filename, endname):
...
async def gggne_meeme(upper_text, lower_text, CNG_FONTS, picture_name, endname):
    main_image = gggneimage(filename=picture_name)
    main_image.resize(
